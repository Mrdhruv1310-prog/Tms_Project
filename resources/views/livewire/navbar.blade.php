    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            <a href="#" class="flex items-center justify-between mr-4">
                <img src="{{ asset('icons/tms.png') }}" class="mr-3 h-8" alt="NS TMS Logo" />
            </a>
        </div>
        {{-- install app button with installBtn id --}}
        <div class="flex items-center space-x-4">
            <button id="install" class=" px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800"
                type="button">Install App</button>
        ...
        <div class="relative">
            ...
            <button type="button" data-dropdown-toggle="notification-dropdown"
                ...
                <!-- Bell icon -->
                <svg inert class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
            ...
            <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl"
                    ...
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div
                                ...
                                <svg inert class="w-3 h-3 text-white" fill="currentColor"
                ...
                <a href="#"
                    ...
                    <div class="inline-flex items-center">
                        <svg inert class="mr-2 w-4 h-4 text-gray-500 dark:text-gray-400"
            ...
            <button type="button"
                ...
                id="user-menu-button" aria-expanded="false" data-dropdown-toggle="nav-user-dropdown">
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                ...
                <div class="py-3 px-4">
                    <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{Str::ucfirst(auth()->user()->first_name)}} {{Str::ucfirst(auth()->user()->last_name)}}</span>
                    <span class="block text-sm text-gray-900 truncate dark:text-white">{{auth()->user()->email}}</span>
                </div>
                {{-- <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="nav-user-dropdown">
                    <li>
                        <a href="#"
