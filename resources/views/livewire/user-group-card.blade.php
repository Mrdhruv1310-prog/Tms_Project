        ...
        <div class="relative mb-6 flex flex-col items-center sm:flex-row sm:justify-center space-x-4">
            ...
            <div class="relative mb-4 sm:mb-0">
                ...
                <label for="floating_outlined"
                    class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Group
                    Name</label>
                @error('newGroup')
        ...
        <div x-data="{ userId: null }" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @foreach ($groups as $group)
                <div wire:key="{{ $group['id'] }}"
                    class="relative w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg dark:bg-gray-800 dark:border-gray-700 transition duration-300">
                    <div class="flex flex-col items-center px-6 py-8">
                                ...
                                <div class="flex gap-4">
                                    <button wire:click="saveGroupName"
                                        ...
                                        <svg wire:loading wire:target="saveGroupName"
                                            class="w-5 h-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <button wire:click="cancelEditing"
                                        ...
                                        <svg wire:loading wire:target="cancelEditing"
                                            class="w-5 h-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 24 24">
                                            <circle class="opacity-25" cx="12" cy="12" r="10"
                                                stroke="currentColor" stroke-width="4"></circle>
                        ...
                        <div class="flex gap-4 mt-4">
                            ...
                            <button wire:click="$dispatch('openUserGroupModal',{ labelId: {{ $group['id'] }} })"
                                x-data="{ isLoading: false }" x-on:click="isLoading = true"
                                ...
                                <!-- Icon or Loader -->
                                <svg x-show="!isLoading" class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24">
                                ...
                                <svg x-show="isLoading" class="w-5 h-5 mr-2 animate-spin text-gray-500"
                            ...
                            <!-- Edit Button -->
                            <button wire:click="startEditing({{ $group['id'] }}, '{{ $group['name'] }}')"
                                ...
                                <svg wire:loading
                                    wire:target="startEditing({{ $group['id'] }}, '{{ $group['name'] }}')"
                                    class="w-5 h-5 animate-spin text-blue-700" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10"
                                        stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor"
