<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-5 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign up for your
            account</h2>
    </div>
    <form wire:submit.prevent="Adminregister" class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <!-- first_name -->
        <div>
